...
sumtab2 <- run(
 patient_table %>% select(-id, -rejection_afterTX) %>% 
  ...
  modify_caption('Patient characteristics according to developed acute rejection') %>% 
   add_p(),
 path = 'gitignore/run/sumtab2', reuse=FALSE)
...
p18_no_reject_90
if(file.exists('gitignore/figures/p18_no_reject_90.pdf') == FALSE){
  ggsave("gitignore/figures/p18_no_reject_90.pdf", 
         plot = p18_no_reject_90, width = 8, height = 5.5, units = "in")
}
...
if(file.exists('gitignore/figures/p18_acute_reject_biopsy.pdf') == FALSE){
  ggsave("gitignore/figures/p18_acute_reject_biopsy.pdf", 
         plot = p18_acute_reject_biopsy, width = 8, height = 5.5, units = "in")
}
```
